import {SessionManager, SessionManagerOptions, SimpleUserDelegate, SimpleUserOptions} from "sip.js/lib/platform/web";
import {
  InvitationAcceptOptions, Inviter,
